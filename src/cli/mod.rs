...
use crate::catalog::{Catalog, DataType, TableSchemaBuilder};
use crate::optimizer::{Optimizer, StorageEngine, Tuple, Val};
...
impl App<'_> {
    pub fn new() -> Self {
        ...
        Self {
            ...
            color_index: 0,
            items: Rc::new(data_vec),
        }
    }

    pub fn next_row(&mut self) {
        let i = match self.t_state.state.selected() {
            Some(i) => {
        ...
        self.t_state.state.select(Some(i));
    ...
    pub fn next_column(&mut self) {
        self.t_state.state.select_next_column();
    }

    pub fn previous_column(&mut self) {
        self.t_state.state.select_previous_column();
    }
    ...
    fn render_table(&mut self, frame: &mut Frame, area: Rect) {
        frame.render_stateful_widget(
            TableWidget {
                ...
                longest_item_lens: self.longest_item_lens,
